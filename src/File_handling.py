...
def correction_calculation(parent, DF):
    ...
    DF['Windspeed_max'] = [Correction_Factor_Calculation.compute_max_rolling(DF['filtered_windspeed'], i, window_size = 42) for i in range(len(DF))]     #Set the rolling window to selec the MAx out of last 35 samples
